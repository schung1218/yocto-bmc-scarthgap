FILESEXTRAPATHS:prepend_ma35h0 := "${THISDIR}/tf-a-ma35h0:"
...
FILESEXTRAPATHS:prepend := "${THISDIR}/tf-a-ma35h0:"

inherit deploy

DEPENDS += "dtc-native"

SUMMARY = "Trusted Firmware-A for ma35h0"
LICENSE = "BSD-3-Clause"
...
# Configure ma35h0 make settings
...
do_compile() {
	...
	if echo ${TFA_DTB} | grep -q "256"; then
            ...
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D1_DRAM_SIZE=0x7F800000 \
                MA35D1_DDR_MAX_SIZE=0x80000000 \
                MA35D1_DRAM_S_BASE=0xFF800000 \
                MA35D1_BL32_BASE=0xFF800000 -C ${S} realclean
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D1_DRAM_SIZE=0x7F800000 \
                MA35D1_DDR_MAX_SIZE=0x80000000 \
                MA35D1_DRAM_S_BASE=0xFF800000 \
                MA35D1_BL32_BASE=0xFF800000 -C ${S} all
            oe_runmake PLAT=${PLATFORM} ${TFA_OPT} \
                MA35D1_DRAM_SIZE=0x7F800000 \
                MA35D1_DDR_MAX_SIZE=0x80000000 \
                MA35D1_DRAM_S_BASE=0xFF800000 \
                MA35D1_BL32_BASE=0xFF800000-C ${S} fiptool
...
do_compile:prepend() {
    if echo ${TFA_DTB} | grep -q "custom"; then
        cp ${WORKDIR}/${TFA_DDR_HEADER} ${S}/plat/nuvoton/ma35h0/include/custom_ddr.h
    fi
}
...
do_deploy() {
    ...
    install -Dm 0755 ${S}/tools/fiptool/fiptool  ${DEPLOYDIR}/${BOOT_TOOLS}/fiptool
}
